...
class ViewController: UIViewController {
    ...
    var swiftGraph: Graph!

    override func viewDidLoad() {
        super.viewDidLoad()
        
//        swiftGraph = createGraph()
//        
//        let path: [Vertex] = swiftGraph.aStarSearch(from: swiftGraph.canvas[0], to: swiftGraph.canvas[9])
...
//        }
    ...
    func createGraph() -> Graph {
        ...
        addSampleVerticesAndEdgesTo(a: graph)
        //testSmallGraph(a: graph)
